...
var monotureControllers = {
  ...
  setting : require('./controllers/monoture/setting')
}
...
module.exports = function(app, monoture, db) {
  ...
  monoture.get('/post/:post.json', authentication.isAuthenticated, monotureControllers.post.json)
  ...
  monoture.get('/post/:post/publish', authentication.isAuthenticated, monotureControllers.post.publish);
  monoture.post('/post', authentication.isAuthenticated, monotureControllers.post.update);

  // Settings
  monoture.get('/settings', authentication.isAuthenticated, monotureControllers.setting.edit);
  monoture.post('/settings', authentication.isAuthenticated, monotureControllers.setting.update);
